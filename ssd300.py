...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 12 17:19:55 2018
...
class SSD300:
    def __init__(self, tf_sess, isTraining):
        ...
        # 允许的图像大小
        self.img_size = [arg_parsing.IMAGE_RESIZE_SHAPE, arg_parsing.IMAGE_RESIZE_SHAPE]
        # 分类总数量
        self.classes_size = arg_parsing.NUM_LABELS
        # 背景分类的值
